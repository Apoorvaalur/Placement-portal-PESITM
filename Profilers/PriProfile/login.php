          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                   <li>
                  <a href="../../Homepage/index.php">Home PESITM</a>
                </li>
                <li>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="square"></div>
              <h2 class="templatemo-inline-block">Welcome to PESITM</h2><hr>
              <p>You can View Student details, Check their Eligibility Criteria and you can look up drive details</p>    
...
?> 
          ...
          <footer class="text-right">
            <p>Copyright &copy; 2024 PESITM | Developed by A4
            </p>
          </footer>       
        </div>
      </div>
