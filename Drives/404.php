				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">PESITM<i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
	...
	<div class="e-page">
		...
		<div class="container">
			...
			<div class="see-button">
				<a class="btn btn-primary btn-lg see-button hvr-shutter-out-horizontal specialty-button e-button footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;" href="index.html" role="button">Take Me Home</a>
			</div>
		</div>
		<!-- //container -->
	</div>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Address</h3>
					<div class="address">
						<p>PESITM, NH 206 BH Road
							<span>Sagar Road, Shimoga- 577204</span>
						</p>
					</div>
					<div class="phone">
						<p>+91 8296317636</p>
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">PES Institute of Technology and Management</h6>
					<h4>
		...
		<div class="copyright">
			...
			<div class="container">
				<div class="copyright-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<p>Copyrights © 2024 PESITM . Developed by
						<a href="#">A4</a>
					</p>
				</div>
				<div class="copyright-right wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<ul>
						...
						<li>
							<a href="https://www.facebook.com/pesitmsmg" class="twitter facebook"> </a>
						</li>
						<li>
						...
						<li>
							<a href="https://www.linkedin.com/in/pes-institute-of-technology-and-management-b119522b5/" class="twitter linkedin"> </a>
						</li>
						<li>
