		...
		<div class="container">
			<div class="header">
				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="ding">
								<a href="../Homepage/index.php">PESITM-Home</a>
							</li>
						<li class="ding">
			...
			<div class="team-info">
				...
				<div class="team-grids">
					...
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						...
						<h6>Rajesh T H</h6>
						<p>Assistant Professor, CSE Department</p>
					</div>
					<div class="clearfix"> </div>
				</div>
			</div>
		...
		<div class="copyright">
			...
			<div class="container">
				<div class="copyright-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					 <p>Copyright &copy; 2024 PESITM | Developed by A2
					</p>
				</div>
