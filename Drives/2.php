		...
		<div class="container">
			<div class="header">
				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="ding">
								<a href="../Homepage/index.php">PESITM-PP</a>
							</li>
						<li class="ding">
		...
		<div class="copyright">
			...
			<div class="container">
				<div class="copyright-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					 <p>Copyright &copy; 2024 PESITM-PP | Developed by
              <a href="http://znumerique.azurewebsites.net" target="_parent">A4</a>
				</div>
